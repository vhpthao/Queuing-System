...
function Header() {
  ...
  // Lấy giá trị key từ đường dẫn URL
  const { key } = useParams();

  // Đối tượng ánh xạ đường dẫn URL sang tên breadcrumb
  const breadcrumbNames = [
    { path: 'trangchu', name: 'Trang chủ' },
  ...
  const renderBreadcrumb = () => {
    // Kiểm tra xem có đang ở trang cập nhật hoặc chi tiết không
  ...
  // Sử dụng trạng thái để lưu thông tin người dùng
  ...
  return (
    <div style={{display:'flex'}}>
      ...
      <div className='rightCaNhan'>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" className='chuong'>
