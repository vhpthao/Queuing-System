...
const items: MenuItem[] = [
  getItem('Dashboard', '1', (
    <Link to="/trangchu" style={{ marginLeft: '-50px', color: 'black' }}>
      <img src={das} alt="das" className='imgMenu' />
    </Link>
  )),
  getItem('Thiết bị', '2', (
    <Link to="/thietbi" style={{ marginLeft: '-70px' }}>
      <img src={tb} alt="tb" className='imgMenu' />
    </Link>
  )),
  getItem('Dịch vụ', '3', (
    <Link to="/dichvu" style={{ marginLeft: '-70px' }}>
      <img src={dv} alt="dv" className='imgMenu' />
    </Link>
  )),
  getItem('Cấp số', '4', (
    <Link to="/capso" style={{ marginLeft: '-70px' }}>
      <img src={cs} alt="cs" className='imgMenu' />
    </Link>
  )),
  getItem('Báo cáo', '5', (
    <Link to="/baocao" style={{ marginLeft: '-70px' }}>
