...
function TTCaNhan() {
    ...
    const [matKhau, setMatKhau] = useState(localStorage.getItem('matKhau') || '');
    const [tenDN, setTenDN] = useState(localStorage.getItem('tenDN') || '');
  ...
  useEffect(() => {
    if (currentUser) {
      ...
      setMatKhau(currentUser.matKhau);
      setVaiTro(currentUser.vaiTro);
      setMatKhau(currentUser.matKhau);
      setTenDN(currentUser.tenDN);
    }
