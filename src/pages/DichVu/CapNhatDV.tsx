...
function CapNhatDV() {
  return (
    ...
    <p className='ddTB'><Link to={'/dichvu/chitietdv'} style={{textDecoration:'none', color:'rgb(126, 125, 136,1)'}}>Chi tiết {'>'}</Link></p>
    <p className='ddDSTB'>Cập nhật</p>
...
<div>
  <section className='scThemDV'>
    ...
    <Input size='large' style={{width:'450px', marginLeft:'30px'}} value={'201'}/>
       
        <p style={{marginLeft:'-330px'}}>Tên dịch vụ <span style={{color:'red'}}>*</span></p>
    <Input size='large' style={{width:'450px', marginLeft:'30px'}} value={'Khám tim mạch'}/>
    </div>
    ...
    <div style={{display:'flex'}} className='qtcsKC'>
        ...
        <Input size='large' style={{width:'80px', height:'40px'}} value={'0001'}/>
        <p style={{fontWeight:'500',marginRight:'20px', marginLeft:'20px'}}>đến: </p>
        <Input size='large' style={{width:'80px',height:'40px'}} value={'9999'}/>
    </div>
    <div style={{display:'flex'}} className='qtcsKC'>
  ...
  <div style={{display:'flex', marginLeft:'420px'}}>
    ...
    <Button className='scbtnTTB'>Cập nhật</Button>
  </div>
</div>
