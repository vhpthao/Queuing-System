...
import { Avatar, Button, DatePicker, DatePickerProps, Dropdown, Input, MenuProps, Space, Table, Tag } from 'antd'
...
const columns: ColumnsType<DataType> = [
  ...
  },
  {
    ...
    render: (_, record) => (
      <Space size="middle">
      <Link to={'/dichvu/chitietdv'} style={{ textDecoration: 'underline' }}>Chi tiết</Link>
      </Space>
    ),
  },
  {
    ...
    render: (_, record) => (
      <Space size="middle">
        <Link to={'/dichvu/capnhatdv'} style={{ textDecoration: 'underline' }}>Cập nhật</Link>
      </Space>
    ),
  },
];
...
<div>
  <div style={{display:'flex',}} className='ddChung'>
    ...
    <p className='ddDSTB'>Danh sách dịch vụ</p>
...
<Avatar shape="circle" size={50} src="https://i.pinimg.com/564x/fa/85/05/fa8505aa42f880dd74e2eee9bba79647.jpg" alt="gojo" style={{marginTop:'15px',marginRight:'5px'}} />
  ...
  <p className='tieude'>Quản lý dịch vụ</p>
...
<div style={{marginLeft:'50px'}}>
    ...
    <DatePicker onChange={onChange} style={{height:'43px', marginRight:'20px',width:'130px'}} />
    <DatePicker onChange={onChange} style={{height:'43px', width:'130px'}}/>
...
<div style={{display:'flex'}}>
  ...
  <Button className='btnTTB'>
    <Link to={'/dichvu/themdv'} style={{textDecoration:'none'}}>
