...
import { fetchDataFromFirebaseDV } from '../../store/dichVuSlice';
...
function ThemDichVu() {
  ...
  const handleThemDV = async () => {
    ...
    try {
      ...
      // Gọi hàm tạo log sau khi thêm dịch vụ thành công
      await taoLog();
  ...
  // lấy giá trị sau khi người dùng thêm dịch vụ
  const taoLog = async () => {
    const logEntry = {
