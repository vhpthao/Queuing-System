...
import { fetchDataFromFirebase, selectVT } from '../../../store/roleSlice'
...
function UpdateRole() {
  ...
  .then((docSnapshot) => {
    if (docSnapshot.exists()) {
      ...
      dispatch(selectVT({ ...selectedRole, ...updatedData }) as any);
          setTenVT('');
          setMoTa('');
  ...
  useEffect(() => {
    if (selectedRole) {
      setTenVT(selectedRole.tenVT || '');
      setMoTa(selectedRole.moTa || '');

      setIsSelectedTCA(selectedRole.isSelectedTCA || false);
      setIsSelectedXA(selectedRole.isSelectedXA || false);
      setIsSelectedYA(selectedRole.isSelectedYA || false);
      setIsSelectedZA(selectedRole.isSelectedZA || false);
  
      setIsSelectedTCB(selectedRole.isSelectedTCB || false);
      setIsSelectedXB(selectedRole.isSelectedXB || false);
      setIsSelectedYB(selectedRole.isSelectedYB || false);
      setIsSelectedZB(selectedRole.isSelectedZB || false);
