...
<div>
  <section className='scTTB'>
    ...
    <Input size='large' style={{width:'450px', marginLeft:'30px'}} value={'ưoeugo'}/>
        </div>
...
{/* h2 */}
    ...
    <Input size='large' style={{width:'450px', marginLeft:'30px'}} value={'abca'}/>
        </div>

        <div style={{marginLeft:'50px'}}>
    <p style={{marginLeft:'-390px'}}>Tên đăng nhập <span style={{color:'red'}}>*</span></p>
    <Input size='large' style={{width:'500px'}} value={'abca'}/>
</div>
    </div>
    ...
    <Input size='large' style={{width:'1000px', marginLeft:'30px'}} value={'abca'}/>
    <br />
